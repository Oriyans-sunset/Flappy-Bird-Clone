...
#background
ground_surface = pygame.image.load('sprites/base.png')
ground_surface = pygame.transform.scale2x(ground_surface)
background_surface = pygame.image.load('sprites/background-day.png')
...
#player
bird_surface_downflap = pygame.image.load('sprites/bluebird-downflap.png')
bird_surface_midflap = pygame.image.load('sprites/bluebird-upflap.png')
bird_surface_upflap = pygame.image.load('sprites/bluebird-downflap.png')
...
#pipes
pipe_surface_bottom = pygame.image.load('sprites/pipe-green.png')
pipe_rect_list = []
pipe_surface_upper = pygame.image.load('sprites/pipe-red.png')
pipe_surface_upper = pygame.transform.rotate(pipe_surface_upper, 180)
upper_pipe_rect_list  = []

#score
test_font = pygame.font.Font('joystix/joystix monospace.ttf', 20)

#game over text
game_over_text_surface = pygame.image.load('sprites/gameover.png')
...
#sound
die_sound = pygame.mixer.Sound('audio/point.wav')
